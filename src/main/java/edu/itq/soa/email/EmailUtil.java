...
public class EmailUtil {
    ...
    public static String generateTableHtml(String nombres, String apellidoPat,
        ...
        String htmlPara2 = "<p>Estimado " + nombres + " " + apellidoPat + " "
                + apellidoMat
                + ", le informamos que no se pudo generar su tabla de amortización debido a que se encuentra en el buró de crédito.</p>";
        ...
        if (tabla != null) {
            ...
            htmlBody = "<body>" + htmlPara + "<h3>Tabla Amortización</h3>"
                    + htmlTablaTh + htmlTablaContenido + "</table></body></html>";
        } else {
            htmlBody = "<body>" + htmlPara2 + "</body></html>";
        }
